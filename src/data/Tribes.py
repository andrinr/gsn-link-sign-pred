...
class Tribes(InMemoryDataset):
    ...
    def __init__(self, root: str,
        ...
        self.raw_name = 'download.tsv.ucidata-gama'
        self.names = ['meta.ucidata-gama', 'out.ucidata-gama', 'README.ucidata-gama']
    ...
    def raw_file_names(self) -> str:
        return [osp.join('ucidata-gama', s) for s in self.names]

    @property
    def processed_file_names(self) -> str:
        return 'ucidata-gama.pt'
