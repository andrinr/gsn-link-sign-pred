...
forces_friend = sm.heuristic_force(params, distances, jnp.ones((100,)))
forces_neutral = sm.heuristic_force(params, distances, jnp.zeros((100,)))
forces_enemy = sm.heuristic_force(params, distances, -jnp.ones((100,)))
